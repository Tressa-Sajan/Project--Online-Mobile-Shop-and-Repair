# Generated by Django 4.2.6 on 2024-03-20 19:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town2', models.CharField(choices=[('Athirampuzha', 'Athirampuzha'), ('Chengalam', 'Chengalam'), ('Erattupetta', 'Erattupetta'), ('Ettumanoor', 'Ettumanoor'), ('Kottayam', 'Kottayam'), ('Nattakam', 'Nattakam'), ('Paippad', 'Paippad'), ('Palai', 'Palai'), ('Puthuppally', 'Puthuppally'), ('Vellavoor', 'Vellavoor')], max_length=100, null=True)),
